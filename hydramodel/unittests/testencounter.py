...
from hydramodel import encounter
...
class DemoTestCase(unittest.TestCase):
    ...
    def testInsertEncounter(self):
        emailAddr='testInsertEncounter0@hydrauser.com'
        ...
        self.assertIsInstance( result, encounter.Encounter)
