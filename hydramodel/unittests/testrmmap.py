...
class DemoTestCase(unittest.TestCase):
    ...
    def testInsertRMMap(self):
        emailAddr='testInsertRMMap0@hydrauser.com'
        ...
        self.assertIsInstance( result[0], rmmap.RMMap)

    def testCloneRMMap(self):
        eAddrs=['testCloneRMMap0@hydrauser.com',
                'testCloneRMMap1@hydrauser.com']
        ...
        self.assertIsInstance( result, rmmap.RMMap)
